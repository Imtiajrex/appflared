/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 349866061322023e46961973b58a7ad0)
// Runtime types generated with workerd@1.20251202.0 2025-12-02 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WebSocketHibernationServer" | "MONGO_DURABLE_OBJECT";
	}
	interface Env {
		MONGO_URI: string;
		MONGO_DB: string;
		WEBSOCKET_HIBERNATION_SERVER: DurableObjectNamespace<import("./src/index").WebSocketHibernationServer>;
		MONGO_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").MONGO_DURABLE_OBJECT>;
		APPFLARE_STORAGE: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MONGO_URI" | "MONGO_DB">> {}
}
